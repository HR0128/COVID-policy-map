...
reader=pd.read_csv("medical_nursinghome_visitors_integrated.csv")

#Convert policy to index
policyname=reader["PolicyName"].astype(str)
no_elective_process_dict={ 'Nursing Home Visitors Banned Start':1, 'Nursing Home Visitors Banned End':-1}
...
#reader.to_csv("medical_nursing_home_visitors_policyasindex.csv")
...
#Diffform.to_csv("medical_nursing home_visitors_diffform.csv")
...
Sumform.to_csv("medical_nursing home_visitors_sumform.csv")
