...
reader=pd.read_csv("Restaurants_integrated.csv")

#Convert policy to index
policyname=reader["PolicyName"].astype(str)
res_dict={"Closed":5, "Capacity 25":4, "Capacity 50":3, "Capacity 50plus":2,
 "Capacity 100":-10, "Outdoor":1,"Vaccine Required For Entry - Start":0}

policyindex=[]
for i in policyname:
        policyindex.append(res_dict[i])
...
#reader.to_csv("Restaurants_policyasindex.csv")
...
#Diffform.to_csv("Restaurants_diffform.csv")
...
Sumform.to_csv("Restaurants_sumform.csv")
